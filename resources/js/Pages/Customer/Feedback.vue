...
<template>
    ...
    <CustomerLayout>
        <div
            class="min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8 font-rem"
        >
            <div
                class="shadow-xl bg-[#EFEFEF]/20 rounded-2xl p-6 sm:p-8 md:p-10 w-full max-w-5xl"
            >
                <h1
                    class="text-2xl sm:text-3xl font-extrabold text-dark mb-8 sm:mb-10 uppercase text-center md:text-left"
                >
                    Feedback
                </h1>
                ...
                <div class="space-y-10">
                    ...
                    <section class="text-center">
                        <h2
                            class="text-3xl sm:text-4xl font-bold text-dark mb-4"
                        >
                            We Hear You
                        </h2>
                    ...
                    <section class="px-2 sm:px-4 md:px-8">
                        <label
                            for="name"
                            class="ml-[92px] block text-base sm:text-lg font-semibold text-dark mb-4"
                        >
                            Name (optional)
                        </label>
                        <input
                    ...
                    <section class="px-2 sm:px-4 md:px-8">
                        <label
                            for="feedback"
                            class="ml-[92px] block text-base sm:text-lg font-semibold text-dark mb-3"
                        >
                    ...
                    <!-- Submit Button -->
                    <div
                        class="flex justify-center sm:justify-end pt-4 sm:pt-6"
                    >
                        <PrimaryButton
