            ...
            >
                <div class="overflow-auto max-h-[600px]">
                    ...
                    >
                        ...
                        >
                            <thead
                                class="bg-neutral text-white text-xs uppercase"
                            >
                                <tr>
                            ...
                            <tbody>
                                ...
                                >
                                    <td
                                        class="border px-3 py-4 text-center font-semibold"
                                    >
                                        {{ i + 1 }}
                                    </td>
                                    ...
                                    <td
                                        class="border px-3 py-4 max-w-[250px] whitespace-normal"
                                    >
                                        {{ p.procedure }}
                                    </td>
                                    <td class="border px-3 py-4">
                                    ...
                                    <td
                                        class="border px-3 py-4 text-green-600 font-medium"
                                    >
                                        {{ p.status }}
                                    </td>
                                    <td class="border px-3 py-4">
