...
const handleCreate = () => {
    ...
    form.post(route("admin.staff.store"), {
        ...
        onError: () => {
            toast.error(
                "Error creating staff account. Please check the input fields."
            );
        },
    });
};
...
function toggleStaffStatus(staff, action) {
    ...
    router.post(
        ...
        { active: isActivate },
        {
            ...
            onError: () => {
                toast.error(
                    `Failed to ${isActivate ? "activate" : "deactivate"} staff.`
                );
            },
        }
    );
    ...
    <AdminLayout>
        <div class="min-h-screen bg-light/30 p-8 font-rem">
            ...
            <div class="max-w-6xl mx-auto mb-6">
                <div
                    class="flex items-center bg-white py-1.5 px-12 w-fit rounded-lg border border-dark mt-2"
                >
                    <button
