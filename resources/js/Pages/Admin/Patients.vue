    ...
    <div class="min-h-screen">
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-10 py-8">
        ...
        <div class="mb-8 flex flex-col lg:flex-row gap-6 items-start">
          ...
          <!-- Total Patients Card -->
          <div class="bg-white rounded-lg shadow-lg p-6 flex items-center gap-4 min-w-[280px]">
            <div class="bg-teal-50 rounded-lg p-4 flex items-center justify-center min-w-[80px]">
              <span class="text-4xl font-bold text-teal-700">{{ totalPatients }}</span>
            </div>
            <div class="text-lg font-semibold text-teal-700">Total Patients</div>
          </div>
        </div>

        <!-- Table -->
        <div class="bg-white rounded-2xl shadow-md border border-gray-200 w-full mx-auto p-8 flex flex-col">
          <div class="overflow-y-auto rounded-xl h-full">
            <table class="min-w-full border-separate border-spacing-0">
              <thead>
                <tr class="bg-neutral text-white">
                  <th class="px-6 py-4 text-sm font-bold uppercase tracking-wide border-r border-white rounded-tl-xl text-center">
                    ID
                  </th>
                  <th class="px-6 py-4 text-sm font-bold uppercase tracking-wide border-r border-white text-center">
                    Last Name
                  </th>
                  <th class="px-6 py-4 text-sm font-bold uppercase tracking-wide border-r border-white text-center">
                    First Name
                  ...
                  <th class="px-6 py-4 text-sm font-bold uppercase tracking-wide rounded-tr-xl text-center">
                    Action
                  </th>
                </tr>
              </thead>
